...
namespace BlogSystem.Migrations
{
    ...
    [Migration("20230902180902_models")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.BlogPost", b =>
                {
                    b.HasOne("BlogSystem.Areas.Identity.Data.ApplicationUser", "Creator")
                        .WithMany("BlogPosts")
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.Comment", b =>
                {
                    ...
                    b.HasOne("BlogSystem.Core.Models.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("BlogSystem.Core.Models.Like", b =>
                {
                    ...
                    b.HasOne("BlogSystem.Areas.Identity.Data.ApplicationUser", "User")
                        .WithMany("Likes")
